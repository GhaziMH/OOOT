...
{
    internal class MaxVolumeInequality : MaxVolumeBase, IInequality
    {
        public MaxVolumeInequality(TessellatedSolid tessellatedSolid, double thickness, double LargestArea, double maxAllowable)
            : base(tessellatedSolid, thickness, LargestArea)
        {
            this.MaxAllowable = maxAllowable;
        }

        public double MaxAllowable { get; }

        public double calculate(double[] x)
        {
             return calculateFull(x) - MaxAllowable;
        }
    }
    internal class MaxVolumeObjFun : MaxVolumeBase, IObjectiveFunction
    {
        public MaxVolumeObjFun(TessellatedSolid tessellatedSolid, double thickness, double LargestArea) : base(tessellatedSolid, thickness, LargestArea)
        {
        }

        public double calculate(double[] x)
        {
            return calculateFull(x);
        }
    }
    internal class MaxVolumeBase
    {
        ...
        protected MaxVolumeBase(TessellatedSolid tessellatedSolid, double thickness, double LargestArea)
        {
        ...
        protected virtual double calculateFull(double[] x)
        {
